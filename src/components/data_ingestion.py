...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        ...
        try:
            ...
            # PULLING ALL 10 COLUMNS FOR MAXIMUM BRAIN POWER
            query = """
            SELECT 
            ...
            logging.info("Successfully read dataset from MySQL")
            ...
            logging.info("Ingestion complete. Ready for transformation.")
